...
urlpatterns = [
    ...
    path("tickets/<int:pk>/modify/", TicketUpdateView.as_view(),
         name="ticket_modify"),
    ...
    path("review/create/<int:ticket_id>/", ReviewCreateView.as_view(),
         name="review_create_for_ticket"),
    path("review/<int:pk>/modify/", ReviewUpdateView.as_view(),
         name="review_modify"),
